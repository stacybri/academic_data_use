...
models <- list(
  ...
  'Articles Using Data Published in Top 500 journals by Impact Factor'=lm(log_data_papers_top500 ~ log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) , data=reg_df_fixedn), #poisson regression used because logging the top 200 drops several countries with counts of 0
