...
stacked_df <- bind_rows(
  ...
  country_scores_recent_df %>%
    select(iso3c, country, region, income_level, NY.GDP.PCAP.PP.KD, SP.POP.TOTL, data_papers, data_papers_top500) %>%
    mutate(
  ...
  # Top 200 papers only
  country_scores_recent_df %>%
    select(iso3c, country, region, income_level, NY.GDP.PCAP.PP.KD, SP.POP.TOTL, data_papers, data_papers_top200) %>%
    mutate(
    ...
    # Top 100 papers only
  country_scores_recent_df %>%
    select(iso3c, country, region, income_level, NY.GDP.PCAP.PP.KD, SP.POP.TOTL, data_papers, data_papers_top100) %>%
    mutate(
  ...
  country_scores_recent_df %>%
    select(iso3c, country, region, income_level, NY.GDP.PCAP.PP.KD, SP.POP.TOTL, data_papers, citations_data_use_articles) %>%
    mutate(
  ...
  mutate(
    log_papers = log(ifelse(data_papers == 0, 0.05, data_papers)),
...
models <- list(
  ...
  'Stacked Articles Using Data'=lm(log_papers ~ log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) + 
      weighted_500_dummy + log_gdp:weighted_500_dummy + log_pop:weighted_500_dummy,
      data=stacked_df %>% filter(type %in% c("All Articles", "Top 500 Articles"))),
  ...
  'Stacked Articles Using Data'=glm(data_papers ~ log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) + 
      weighted_200_dummy + log_gdp:weighted_200_dummy + log_pop:weighted_200_dummy,
      data=stacked_df %>% filter(type %in% c("All Articles", "Top 200 Articles")), family='poisson'),
  'Stacked Articles Using Data'=glm(data_papers ~ log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) + 
      weighted_100_dummy + log_gdp:weighted_100_dummy + log_pop:weighted_100_dummy,
      data=stacked_df%>% filter(type %in% c("All Articles", "Top 100 Articles")), family='poisson'),
  'Stacked Articles Using Data'=glm(data_papers ~ log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) + 
      weighted_citation_dummy + log_gdp:weighted_citation_dummy  + log_pop:weighted_citation_dummy ,
  ...
  'Citation Count of Articles Using Data'=lm(log_citations_data_use_articles ~   log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL),  data=reg_df_fixedn),
  ...
  'Any Article Using Data'=lm(log(data_papers) ~ SPI.INDEX + log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) , data=reg_df_fixedn),
  ' Any Article Using Data'=lm(log(data_papers) ~ SPI.INDEX + log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) + log(qual_papers+1) , data=reg_df_fixedn),
  ' Any Article Using Data'=lm(log(data_papers) ~   SPI.INDEX.PIL4  + log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) + log(qual_papers+1) , data=reg_df_fixedn)
...
modelsummary(models,
             ...
             coef_map = c(
                             ...
                             "log(SP.POP.TOTL)"="Log Population",
                              ...
                              "weighted_citation_dummy:log_gdp" = "Log GDP X Citation Count of Articles Using Data", 
                              # "weighted_500_dummy" = "Top 500 Articles",
