...
stacked_df <- rbind(
  ...
  country_scores_recent_df %>%
    ...
    mutate(
      papers = citations_data_use_articles,
  ...
  mutate(
    log_papers = log(ifelse(papers == 0, 0.05, papers)),
...
models <- list(
  ...
  'Stacked Articles Using Data'=lm(log_papers ~ log(NY.GDP.PCAP.PP.KD) + log(SP.POP.TOTL) + 
      weighted_500_dummy + log_gdp:weighted_500_dummy +
      weighted_200_dummy + log_gdp:weighted_200_dummy +
      weighted_100_dummy + log_gdp:weighted_100_dummy +
      weighted_citation_dummy + log_gdp:weighted_citation_dummy 
      ,
      data=stacked_df),
